...
if(!function_exists('json_recode')) {
    /**
     ...
     * @return array|object
     */
    function json_recode($var, bool $assoc = false)
    {
        return json_decode(json_encode($var), $assoc);
    }
}

if(!function_exists('obj_reflect')) {
    /**
    ...
    function obj_reflect($obj, bool $to_array=false, $default=null)
    {
        $reflector = function($obj1, bool $to_array=false) {
            ...
            $retval = !empty($obt) ? ($to_array ? json_recode($obt, true) : $obt) : $retval;
            point1:
            return $retval;
        };
...
if(!function_exists('str_version_compare')) {
    /**
...
if(!function_exists('str_version_ge')) {
    /**
...
if(!function_exists('str_preg_match')) {
    /**
...
if(!function_exists('str_filled_eval')) {
    /**
...
if(!function_exists('str_filled_eval_self')) {
    /**
...
if(!function_exists('str_only_alphanumus')) {
    /**
...
if(!function_exists('arr_type_seq')) {
    /**
...
if(!function_exists('arr_type_assoc')) {
    /**
...
if(!function_exists('arr_structure')) {
    /**
...
if(!function_exists('arr_colval_exists')) {
...
if(!function_exists('dt_standard_format')) {
    /**
...
if(!function_exists('dt_is_carbon')) {
    /**
...
if(!function_exists('dt_parse_str')) {
    /**
...
if(!function_exists('dt_format_eval')) {
    /**
...
/**
 * Set config to `core` key
 *
 * @param string $key
 * @param mixed $val
 * @return void
 */
function config_set_core(string $key, $val)
{
    config()->set('core.'.$key, $val);
}
