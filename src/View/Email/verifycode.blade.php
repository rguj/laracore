  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:auto;border-spacing:0;border-collapse:collapse;padding:0">
    <tbody><tr style="padding:0">
      <td align="left" valign="middle" style="word-break:break-word;border-collapse:collapse!important;padding:0">
        ...
        <h1 style="word-break:normal;line-height:21px;font-size:18px;font-weight:700;padding-bottom:10px;margin:0">Welcome <a href="mailto:{{ $data['to']['email'] }}" style="color:#00b08c!important" target="_blank">{{ $data['to']['email'] }}</a></h1>

        <p style="font-size:14px;padding-bottom:10px;margin:0">Thank you for signing up for <span class="il">{{ $data['from']['name'] }}</span>.</p>
        <p style="font-size:14px;padding-bottom:10px;margin:0">Please verify your email address by clicking the button below.</p>
      </td>
    </tr>
    ...
    <tr style="padding:0">
      <td align="center" valign="middle" style="word-break:break-word;border-collapse:collapse!important;padding:25px 0px 0px">
        <table border="0" cellpadding="0" cellspacing="0" width="335" class="m_3525988403364873053button-block" style="table-layout:auto;border-spacing:0;border-collapse:separate;width:auto;padding:0">
          <tbody><tr style="padding:0">
            <td align="center" valign="middle" class="m_3525988403364873053button" style="word-break:break-word;border-collapse:collapse!important;border-radius:25px;padding:10px 25px" bgcolor="#00b08c">
              <a href="{{ $data['to']['link_activate'] }}" style="color:#fff!important;display:block;font-size:14px;font-weight:700;text-decoration:none" target="_blank">Verify my account</a>
            </td>
          </tr>
        </tbody></table>
      </td>
    ...
    <tr style="padding:0">
      <td align="left" valign="middle" style="word-break:break-word;border-collapse:collapse!important;padding: 30px 0px 0px 0px;">
        <p style="font-size:14px;padding-bottom:10px;margin:0">Or, enter this code on the <a style="color:#00b08c!important" href="{{ $data['to']['link_manual'] }}">Email Verification Page</a>.<br></p>
      </td>
    </tr>
